...
Adapted from esp32-emu-turbo patterns + official Anthropic docs.
...
- BAD: "Run tests"
- GOOD: "Run the project test suite via Docker/OrbStack. Use this after code changes to verify correctness, run specific test files, or check coverage."
